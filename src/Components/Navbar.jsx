            ...
            <div className="bg-black pb-20">
                <div className={`fixed w-full ${scroll ? 'bg-blake py-4 border-b' : 'py-8'}`}>
                    <div className="flex items-center justify-between">
                        ...
                        <div onClick={handleView} className="mr-10  lg:hidden text-4xl text-white"><HiOutlineBars3BottomRight /></div>
                    </div>
                </div><br /><br /><br /><br /><br /><br />
                <div className="text-5xl pl-4 lg:pl-20 text-white font-bold">Contact Info</div>
            </div>
        </div>
    )
}
